...
execute_process(
  COMMAND "/opt/homebrew/bin/git" --git-dir=.git show-ref "0.8.2"
  WORKING_DIRECTORY "/Users/sumitmadde/Desktop/Synthetic Pair Deviation Engine/build/websocketpp-prefix/src/websocketpp"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/Users/sumitmadde/Desktop/Synthetic Pair Deviation Engine/build/websocketpp-prefix/src/websocketpp'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/Users/sumitmadde/Desktop/Synthetic Pair Deviation Engine/build/websocketpp-prefix/src/websocketpp'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
